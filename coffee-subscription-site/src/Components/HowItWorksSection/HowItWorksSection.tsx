...
interface Props {
    ...
    howItWorksStyling?: 'backgroundColor'
}

export default function HowItWorksSection(props: Props) {
    return (
        <section className="how-it-works-section">
            {
                props.headerVisible && <h1>How it works</h1>
            }
            <div className="step-card-container" style={props.howItWorksStyling === 'backgroundColor' ? {backgroundColor: 'var(--neutral-900)', color: 'var( --neutral-0)'} : {}}>
            ...
            {
                props.buttonVisible && <Button text="Create your plan" />
            }
        </section>
    )
}